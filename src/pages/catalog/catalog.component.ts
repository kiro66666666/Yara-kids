...
@Component({
  ...
  template: `
    <div class="bg-[#f7f8fc] dark:bg-brand-darkbg min-h-screen pt-4 pb-24 lg:pb-12 transition-colors duration-300">
          ...
          <aside class="fixed inset-y-0 left-0 z-[70] w-[85%] max-w-[320px] bg-white dark:bg-brand-darksurface shadow-2xl transform transition-transform duration-300 h-[100dvh] flex flex-col lg:block lg:static lg:w-64 lg:shadow-none lg:bg-transparent lg:translate-x-0 lg:h-auto lg:overflow-visible"
             ...
             <div class="flex-1 overflow-y-auto p-6 lg:p-6 lg:rounded-3xl lg:bg-white lg:dark:bg-brand-darksurface lg:shadow-sm lg:border lg:border-gray-100 lg:dark:border-gray-700 lg:sticky lg:top-24 transition-colors custom-scrollbar pb-24 lg:pb-6">
                 ...
                 <div class="flex items-center gap-2">
                   <div class="relative flex-1 group">
                     ...
                     <input type="number" 
                            ...
                            placeholder="0" 
                            class="w-full pl-8 py-2 bg-[#f7f8fc] dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-lg text-sm font-bold text-gray-700 dark:text-gray-200 focus:bg-white dark:focus:bg-gray-700 focus:border-brand-pink focus:ring-2 focus:ring-brand-pink/20 outline-none transition-all">
                   </div>
              ...
              <div class="mb-8">
                 ...
                 <div class="space-y-2">
                    <label class="flex items-center gap-3 cursor-pointer group p-2 rounded-lg hover:bg-[#f7f8fc] dark:hover:bg-gray-700 transition-colors -mx-2">
