          ...
          <div class="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
            ...
            <div>
              ...
              <ul class="space-y-3 text-sm text-gray-500 dark:text-gray-400 font-medium">
                ...
                <!-- New Feedback Link -->
                <li><a routerLink="/feedback" class="hover:text-brand-pink transition-colors flex items-center gap-2 font-bold text-brand-lilac">Avalie sua Experiência</a></li>
              </ul>
            </div>
...
export class FooterComponent {
  ...
  subscribe() {
    if (this.email && this.email.includes('@')) {
      ...
      this.store.showToast('Inscrição confirmada! Verifique seu e-mail 🎁', 'success');
      this.email = '';
    } else {
